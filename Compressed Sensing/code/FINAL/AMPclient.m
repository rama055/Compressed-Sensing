...
lenk=length(k);
lent=length(t);
save('C:\Users\abhishek_sharma92\Desktop\project\code\allAMP.mat','lenb','lenk','lent','b','k','n','m','Fs','T','tol','t','f','-ascii','-double','-tabs')
cont=input('Press Y to send samples to the server or N to abort: ','s');
switch(cont)
    case 'N' 
        exit;
    case 'Y' 
        client('192.168.2.5',3000,'C:\Users\abhishek_sharma92\Desktop\project\code\allAMP.mat');
    case 'n'
        exit;
    case 'y'
        client('192.168.2.5',3000,'C:\Users\abhishek_sharma92\Desktop\project\code\allAMP.mat');
